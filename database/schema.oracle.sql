...
CREATE TABLE suggestions_ia (
    ...
    predicted_risk_level VARCHAR2(20) NOT NULL,
    predicted_expiration_probability NUMBER(5, 2) NOT NULL,
    ...
    CONSTRAINT chk_suggestions_ia_risk CHECK (predicted_risk_level IN ('low', 'medium', 'high'))
);
...
CREATE TABLE report_consultations_super_admin (
    id NUMBER(19) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    report_id NUMBER(19) NOT NULL,
