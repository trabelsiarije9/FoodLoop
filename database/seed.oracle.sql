...
INSERT INTO annonces (id_annonce, titre, description, type_aliment, prix, quantite, unite, localisation, statut, public_visibility_at, pickup_start, pickup_end, date_expiration, categorie_id, zone_id, proprietaire_id, created_at, updated_at)
VALUES (1, 'Sandwichs invendus du matin', 'Lot de sandwichs frais a redistribuer avant la fin d apres-midi.', 'Boulangerie', 2.90, 35, 'pieces', 'Rue de Rome', 'priority_access', TO_TIMESTAMP('2026-04-20 15:05:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 15:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 16:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 18:30:00', 'YYYY-MM-DD HH24:MI:SS'), 1, 1, 1, TO_TIMESTAMP('2026-04-20 14:05:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 14:05:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO annonces (id_annonce, titre, description, type_aliment, prix, quantite, unite, localisation, statut, public_visibility_at, pickup_start, pickup_end, date_expiration, categorie_id, zone_id, proprietaire_id, created_at, updated_at)
VALUES (2, 'Couscous vegetal midi', 'Barquettes chaudes disponibles pour reservation publique.', 'Plat cuisine', 4.60, 18, 'barquettes', 'La Marsa Plage', 'available', TO_TIMESTAMP('2026-04-20 11:40:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 18:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 19:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 21:00:00', 'YYYY-MM-DD HH24:MI:SS'), 2, 2, 2, TO_TIMESTAMP('2026-04-20 10:40:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 12:10:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO annonces (id_annonce, titre, description, type_aliment, prix, quantite, unite, localisation, statut, public_visibility_at, pickup_start, pickup_end, date_expiration, categorie_id, zone_id, proprietaire_id, created_at, updated_at)
VALUES (3, 'Paniers fruits et laitages', 'Paniers mixtes pour collecte associative rapide.', 'Epicerie', 3.40, 24, 'packs', 'Sfax Medina', 'reserved', TO_TIMESTAMP('2026-04-20 10:20:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 15:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 16:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 19:30:00', 'YYYY-MM-DD HH24:MI:SS'), 3, 3, 3, TO_TIMESTAMP('2026-04-20 09:20:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 13:10:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO annonces (id_annonce, titre, description, type_aliment, prix, quantite, unite, localisation, statut, public_visibility_at, pickup_start, pickup_end, date_expiration, categorie_id, zone_id, proprietaire_id, created_at, updated_at)
VALUES (4, 'Salades pretes a recuperer', 'Portions fraiches a recuperer le soir meme.', 'Repas frais', 2.30, 12, 'box', 'Sousse Corniche', 'available', TO_TIMESTAMP('2026-04-20 12:15:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 17:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 18:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 20:00:00', 'YYYY-MM-DD HH24:MI:SS'), 2, 4, 2, TO_TIMESTAMP('2026-04-20 11:15:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 11:45:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO annonces (id_annonce, titre, description, type_aliment, prix, quantite, unite, localisation, statut, public_visibility_at, pickup_start, pickup_end, date_expiration, categorie_id, zone_id, proprietaire_id, created_at, updated_at)
VALUES (5, 'Yaourts proches de date', 'Lot deja recupere lors de la collecte de midi.', 'Produits laitiers', 1.80, 20, 'pots', 'Bab Bhar', 'picked_up', TO_TIMESTAMP('2026-04-20 08:45:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 12:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 13:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 13:15:00', 'YYYY-MM-DD HH24:MI:SS'), 4, 1, 3, TO_TIMESTAMP('2026-04-20 07:45:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 13:05:00', 'YYYY-MM-DD HH24:MI:SS'));
...
INSERT INTO consultations_annonces (id_consultation, utilisateur_id, annonce_id, date_consultation)
VALUEINSERT INTO utilisateur_zones (utilisateur_id, zone_id) VALUES (1, 1);
...
S (2, 1, 4, TO_TIMESTAMP('2026-04-20 12:45:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO consultations_annonces (id_consultation, utilisateur_id, annonce_id, date_consultation)
...
UES (3, 3, 'high', 88.40, 'Orienter le lot vers une collecte associative multi-adresses avant 16h.', TO_TIMESTAMP('2026-04-20 13:05:00', 'YYYY-MM-DD HH24:MI:SS'), TO_TIMESTAMP('2026-04-20 13:05:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO suggestions_ia (id, food_item_id, predicted_risk_level, predicted_expiration_probability, recommended_action, generated_at, created_at)
